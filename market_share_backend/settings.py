"""
Django settings for market_share_backend project.
...
ROOT_URLCONF = 'market_share_backend.urls'
...
WSGI_APPLICATION = 'market_share_backend.wsgi.application'
...
# User Custom Model
AUTH_USER_MODEL = 'market_share_backend.User'
